...
<h3 class="text-center"> Criar um item </h3>

<form class="mx-5" action="Create/action">
  ...
  <button type="submit" class="btn" style="background-color: #214F4B; color: white;">Enviar</button>
</form>
